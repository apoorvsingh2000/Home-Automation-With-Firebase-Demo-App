...
public class Bedroom1 extends AppCompatActivity {
    ...
    private static final String CHANNEL_ID = "_id_bedroom1";
    private long mElapsedTime;
    private int mPowerBulb, mPowerAC, mPowerFan;
    private String BEDROOM1_POWER_BULB_KEY = "bedroom1_bulb";
    private String BEDROOM1_POWER_AC_KEY = "bedroom1_ac";
    private String BEDROOM1_POWER_FAN_KEY = "bedroom1_fan";
    private int BEDROOM1_DEFAULT_POWER_BULB_VALUE = 7;
    private int BEDROOM1_DEFAULT_POWER_AC_VALUE = 1500;
    private int BEDROOM1_DEFAULT_POWER_FAN_VALUE = 60;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bedroom_1);
        ...
        mBulbReference = mFirebaseDatabase.getReference().child("Bedroom-1").child("Light Bulb");
        mACReference = mFirebaseDatabase.getReference().child("Bedroom-1").child("AC");
        mFanReference = mFirebaseDatabase.getReference().child("Bedroom-1").child("Fan");
        ...
        defaultConfigMap.put(BEDROOM1_POWER_AC_KEY, BEDROOM1_DEFAULT_POWER_AC_VALUE);
        defaultConfigMap.put(BEDROOM1_POWER_BULB_KEY, BEDROOM1_DEFAULT_POWER_BULB_VALUE);
        defaultConfigMap.put(BEDROOM1_POWER_FAN_KEY, BEDROOM1_DEFAULT_POWER_FAN_VALUE);
        ...
        mPowerBulb = BEDROOM1_DEFAULT_POWER_BULB_VALUE;
        mPowerAC = BEDROOM1_DEFAULT_POWER_AC_VALUE;
        mPowerFan = BEDROOM1_DEFAULT_POWER_FAN_VALUE;
        ...
        mFirebaseRemoteConfig.fetchAndActivate()
                .addOnCompleteListener(this, new OnCompleteListener<Boolean>() {
                    ...
                    public void onComplete(@NonNull Task<Boolean> task) {
                        ...
                        mACPowerTextView.setText(mFirebaseRemoteConfig.getString(BEDROOM1_POWER_AC_KEY));
                        mBulbPowerTextView.setText(mFirebaseRemoteConfig.getString(BEDROOM1_POWER_BULB_KEY));
                        mFanPowerTextView.setText(mFirebaseRemoteConfig.getString(BEDROOM1_POWER_FAN_KEY));
                        BEDROOM1_DEFAULT_POWER_AC_VALUE = (int) mFirebaseRemoteConfig.getLong(BEDROOM1_POWER_AC_KEY);
                        BEDROOM1_DEFAULT_POWER_BULB_VALUE = (int) mFirebaseRemoteConfig.getLong(BEDROOM1_POWER_BULB_KEY);
                        BEDROOM1_DEFAULT_POWER_FAN_VALUE = (int) mFirebaseRemoteConfig.getLong(BEDROOM1_POWER_FAN_KEY);
                    }
                });
    }
}
